...
Для событий конкретного пробника или курса передавать `enrollment_id` в `properties`. Без него повторные пробники одной семьи нельзя корректно разделить по когортам.
